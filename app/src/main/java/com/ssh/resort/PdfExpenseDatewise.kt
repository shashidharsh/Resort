...
class PdfExpenseDatewise {
    ...
    fun createUserTable(data: List<ExpenseListData>, paragraphList: List<String>, onFinish: (file: File) -> Unit, onError: (Exception) -> Unit, fromDate: String, toDate: String) {
        //Define the document
        val file = createFile()
        ...
        //Add Title
        document.add(Paragraph("Expenses From " + fromDate + "  To " + toDate, TITLE_FONT))
